...
The Database data provider supports standard [PropertyNameMapper](../repository-data-providers#property-name-mapping) section configuration.  
...
[Search Template configuration for Database repository data provider](../search-templates/db)
