...
category: Unity 7
---
[Dashboard Component description](../components/dashboard)
...
|Security|[Dashboard security restrictions](../../unity-react/configuration/security#security-restrictions)|
...
[Container tag configuration](dashboards/container-tag)  
[Component tag configuration](dashboards/component-tag)
