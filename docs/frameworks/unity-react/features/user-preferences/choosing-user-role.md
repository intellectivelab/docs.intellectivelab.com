...
The feature allows a user to change a role to focus on only those [dashboards](../../configuration/dashboards), 
[components](../../configuration/dashboards/component-tag) and [actions](../../configuration/actions) 
...
- If `All roles` is disabled in [System Properties Configuration](../../configuration/tags-list/system-properties-tag), dropdown will be not clearable.
- This feature is disabled for case when role mode is `RoleUnion` in 
[System Properties Configuration](../../configuration/tags-list/system-properties-tag) section.
...
header and applies to current user context in order to show only those [dashboards](../../configuration/dashboards), 
[components](../../configuration/dashboards/component-tag) and [actions](../../configuration/actions) 
related to that role.
...
This feature is available OOTB, but requires [customization](choosing-user-role#limitation) in case requests to Unity are sent via Gateway. 

[Access Roles Configuration](../../configuration/tags-list/access-roles-tag)
