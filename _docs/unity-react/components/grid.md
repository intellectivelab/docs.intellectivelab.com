...
Clicking to the details view icon will switch grid into the Details View.

![react_grid-table-view-mode](grid/images/displaymode_react_tableview.png) 

### List View

In case the window size is not enough for the correct display of the grid in Table View mode, then the grid is automatically switched into List View mode. 
...
Clicking to the list view icon will switch grid back into the List/Table View.
...
- Bookmarks Panel - displays the bookmarks bar. Bookmarks allow to quickly switch between selected items. List item can be added to bookmark by clicking *Bookmark* action in the item actions menu. A bookmark can also be removed from the bookmarks bar.
